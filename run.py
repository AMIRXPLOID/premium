...
print(" \n\33[0;32m[✓] 🗣️ Jika Anda Belum Mememukan Bug\n[✓]Silakan Hubungi CS nya👇 \n")
print(" \n\33[0;32mKontak CS \33[37;1m: https://wa.me/6285718094505 ")
...
def banner():
	...
	sol().print(wel2)
	au='▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄   +> Au : AmirXploit\n█▄░▄█░▄▀▄░█▀▄▄▀█░▄▄▀█▄░▄█░▄▄▀█░█   +> Supoort : Amir\n██░██░█▄█░█░██░█░▀▀▄██░██░▀▀░█░█   +> Dev : AmirXploit Ex\n█▀░▀█▄███▄██▄▄██▄█▄▄██▄██▄██▄█▄▄   +> Team X code\n▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀   +> WA : 6285718094505 '  # Jangan Di Ubah Ajg -> Kesalahan Code Bakal Merusak Program                                                                                                                                                                                              
...
def menu(name,no_id):
	...
	banner()
	sol()
	sg = '# ☂️ MENU TOOLS BY AMIR'
	fx = mark(sg, style='green')
	sol().print(fx)
	print(x+''+h+'-->'+x+' Username : '+str(name))
	print(x+''+h+'-->'+x+' User Id     : '+str(no_id))
